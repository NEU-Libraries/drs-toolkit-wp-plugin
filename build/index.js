...
/* harmony export */   "fetchFromFile": function() { return /* binding */ fetchFromFile; },
/* harmony export */   "fetchFromSearch": function() { return /* binding */ fetchFromSearch; }
/* harmony export */ });
...
async function fetchFromFile(_ref) {
  let {
    fileId,
    allowedTypes
  } = _ref;
  ...
  try {
    ...
    const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(baseUrl + fileId);
    const {
      data
    } = response;
...
async function fetchFromSearch(_ref3) {
  let {
    collectionId,
    searchParams
  } = _ref3;
  ...
  try {
    let baseUrl = "https://repository.library.northeastern.edu/api/v1/search/" + collectionId + "?"; // short circuiting (&&)
    // object.entries returns array using key,value pairs from the object passed in
    // check below for related links

    searchParams && Object.entries(searchParams).map(_ref4 => {
      let [key, value] = _ref4;
      baseUrl += key + "=" + value + "?";
    });
    const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(baseUrl);
    const {
      data
    } = response;
    return data;
...
const DRSModal = function (_ref) {
  ...
  const [searchParams, setSearchParams] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)({
    per_page: 20
  }); // params to be passed to search api

  const [selectedFile, setSelectedFile] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)({});
  const [urls, setUrls] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)([]); // store the files list
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(async () => {
    try {
      ...
      const result = []; // iterating over the objList and adding to url list
      ...
      objList.forEach(object => {
        if (object.active_fedora_model_ssi === "CoreFile") {
          ...
          fileData.thumbnail = "https://repository.library.northeastern.edu/" + object.fields_thumbnail_list_tesim[object.fields_thumbnail_list_tesim.length - 1];
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Modal, {
    ...
    className: "media-frame-content left-0 border-top-none"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, "File Details"), selectedFile == undefined || selectedFile == null ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, "Select a image") : Object.entries(selectedFile).map(_ref2 => {
    let [key, value] = _ref2;
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
      className: "modal-file-desc-head"
    }, key), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
      className: "modal-file-desc-val"
    }, value));
  }))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "media-frame-toolbar left-0"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "media-toolbar"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
function FileSelect(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
    ...
    className: "attachment-preview js--select-attachment type-image subtype-png landscape"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "thumbnail"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "centered"
...
function InsertFromDRSNumber(_ref) {
  let {
    allowedTypes,
    onSubmit,
    onClose
  } = _ref;
  const [fileUrl, setFileUrl] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(""); // store the url of the file

  const [drsNum, setDrsNum] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)("neu:344525"); // the drs number to be used

  const [submitForm, setSubmitForm] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(false); // if the form is submitted or not
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    const fetchFileFromDRS = async () => {
      try {
        ...
        if (response.err) {// TODO : display a notice here that the file format is invalid for the allowed type
        } else {
  ...
  }, [(axios__WEBPACK_IMPORTED_MODULE_1___default()), drsNum, setFileUrl, submitForm]);
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.URLPopover, {
    onClose: onClose
    ...
    type: "text",
    "aria-label": (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("URL"),
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Paste or type DRS Number"),
    onChange: e => {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Apply"),
    type: "submit"
  })));
}

/* harmony default export */ __webpack_exports__["default"] = (InsertFromDRSNumber);
...
function Edit() {
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)(), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Drs Tk – hello from the editor!', 'drs-tk'));
}
...
function save() {
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps.save(), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Drs Tk – hello from the saved content!', 'drs-tk'));
}
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"ceres/drs-tk","version":"0.1.0","title":"Drs Tk","category":"widgets","icon":"smiley","description":"Example static block scaffolded with Create Block tool.","supports":{"html":false},"textdomain":"drs-tk","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkdrs_tk"] = self["webpackChunkdrs_tk"] || [];
