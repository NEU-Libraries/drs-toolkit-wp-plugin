...
define(
    'DPLA_FALLBACK_IMAGE_URL',
    DRS_PLUGIN_URL . 'assets/images/DPLA-square-logo-color.jpeg'
);
...
function register_drs_settings()
{
    ...
    add_settings_field(
        'drstk_collection',
        'Project Collection or Set URL',
        'drstk_collection_callback',
        'drstk_options',
        'drstk_project'
    );
    ...
    register_setting(
        'drstk_options',
        'drstk_home_url',
        'drstk_home_url_validation'
    );

    //Search Settings
    add_settings_section(
        'drstk_search_settings',
        'Search',
        null,
        'drstk_options'
    );
    add_settings_field(
        'drstk_search_page_title',
        'Search Page Title',
        'drstk_search_page_title_callback',
        'drstk_options',
        'drstk_search_settings'
    );
    register_setting('drstk_options', 'drstk_search_page_title');
    add_settings_field(
        'drstk_search_placeholder',
        'Search Box Placeholder Text',
        'drstk_search_placeholder_callback',
        'drstk_options',
        'drstk_search_settings'
    );
    register_setting('drstk_options', 'drstk_search_placeholder');
    add_settings_field(
        'drstk_search_metadata',
        'Metadata to Display',
        'drstk_search_metadata_callback',
        'drstk_options',
        'drstk_search_settings'
    );
    register_setting('drstk_options', 'drstk_search_metadata');
    add_settings_field(
        'drstk_search_related_content_title',
        'Related Content Title',
        'drstk_search_related_content_title_callback',
        'drstk_options',
        'drstk_search_settings'
    );
    register_setting('drstk_options', 'drstk_search_related_content_title');
    add_settings_field(
        'drstk_default_search_per_page',
        'Default Per Page',
        'drstk_default_search_per_page_callback',
        'drstk_options',
        'drstk_search_settings'
    );
    register_setting('drstk_options', 'drstk_default_search_per_page');
    add_settings_field(
        'drstk_search_show_facets',
        'Show Facets',
        'drstk_search_show_facets_callback',
        'drstk_options',
        'drstk_search_settings'
    );
    ...
    // Browse Settings
    add_settings_section(
        'drstk_browse_settings',
        'Browse',
        null,
        'drstk_options'
    );
    add_settings_field(
        'drstk_browse_page_title',
        'Browse Page Title',
        'drstk_browse_page_title_callback',
        'drstk_options',
        'drstk_browse_settings'
    );
    register_setting('drstk_options', 'drstk_browse_page_title');
    add_settings_field(
        'drstk_browse_metadata',
        'Metadata to Display',
        'drstk_browse_metadata_callback',
        'drstk_options',
        'drstk_browse_settings'
    );
    ...
    add_settings_field(
        'drstk_default_sort',
        'Default Sort',
        'drstk_default_sort_callback',
        'drstk_options',
        'drstk_browse_settings'
    );
    register_setting('drstk_options', 'drstk_default_sort');
    add_settings_field(
        'drstk_default_browse_per_page',
        'Default Per Page',
        'drstk_default_browse_per_page_callback',
        'drstk_options',
        'drstk_browse_settings'
    );
    register_setting('drstk_options', 'drstk_default_browse_per_page');
    add_settings_field(
        'drstk_browse_show_facets',
        'Show Facets',
        'drstk_browse_show_facets_callback',
        'drstk_options',
        'drstk_browse_settings'
    );
    ...
    add_settings_field(
        'drstk_facets',
        'Facets to Display<br/><small>Select which facets you would like to display on the search and browse pages. Once selected, you may enter custom names for these facets. Drag and drop the order of the facets to change the order of display.</small>',
        'drstk_facets_callback',
        'drstk_options',
        'drstk_facet_settings'
    );
    ...
    foreach ($facet_options as $option) {
        add_settings_field(
            'drstk_' . $option . '_title',
            null,
            'drstk_facet_title_callback',
            'drstk_options',
            'drstk_facet_settings',
            ['class' => 'hidden']
        );
    ...
    add_settings_field(
        'drstk_facet_sort_order',
        'Default Facet Sort',
        'drstk_facet_sort_callback',
        'drstk_options',
        'drstk_facet_settings'
    );
    ...
    add_settings_section(
        'drstk_collections_settings',
        'Collections Browse Page',
        null,
        'drstk_options'
    );
    add_settings_field(
        'drstk_collections_page_title',
        'Collections Browse Title',
        'drstk_collections_page_title_callback',
        'drstk_options',
        'drstk_collections_settings'
    );
    ...
    add_settings_section(
        'drstk_collection_settings',
        'Collection Page',
        null,
        'drstk_options'
    );
    add_settings_field(
        'drstk_collection_page_title',
        'Collection Page Title',
        'drstk_collection_page_title_callback',
        'drstk_options',
        'drstk_collection_settings'
    );
    ...
    add_settings_field(
        'drstk_item_page_metadata',
        'Metadata to Display<br/><small>If none are selected, all metadata will display in the default order. To reorder or limit the fields which display, select the desired fields and drag and drop to reorder. To add custom fields, click the add button and type in the label.</small>',
        'drstk_item_page_metadata_callback',
        'drstk_options',
        'drstk_single_settings'
    );
    ...
    add_settings_field(
        'drstk_appears',
        'Display Item Appears In',
        'drstk_appears_callback',
        'drstk_options',
        'drstk_single_settings'
    );
    ...
    add_settings_field(
        'drstk_appears_title',
        'Item Appears In Block Title',
        'drstk_appears_title_callback',
        'drstk_options',
        'drstk_single_settings',
        ['class' => 'appears']
    );
    ...
    add_settings_field(
        'drstk_assoc_title',
        'Associated Files Block Title',
        'drstk_assoc_title_callback',
        'drstk_options',
        'drstk_single_settings',
        ['class' => 'assoc']
    );
    ...
    add_settings_field(
        'drstk_assoc_file_metadata',
        'Metadata to Display',
        'drstk_assoc_file_metadata_callback',
        'drstk_options',
        'drstk_single_settings',
        ['class' => 'assoc']
    );
    ...
    add_settings_field(
        'drstk_annotations',
        'Display Annotations',
        'drstk_annotations_callback',
        'drstk_options',
        'drstk_single_settings'
    );
    register_setting('drstk_options', 'drstk_annotations');
    add_settings_field(
        'drstk_item_extensions',
        'Enable Item Page Custom Text',
        'drstk_item_extensions_callback',
        'drstk_options',
        'drstk_single_settings'
    );
...
function drstk_drs_auth()
{
    if (drstk_api_auth_enabled() == true) {
        ...
        curl_setopt(
            $ch,
            CURLOPT_URL,
            'https://repository.library.northeastern.edu/api/v1/auth_user'
        );
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt(
            $ch,
            CURLOPT_POSTFIELDS,
            'email=' . DRS_API_USER . '&password=' . DRS_API_PASSWORD
        );
...
{
    $plugin_array['drstkshortcodes'] =
        DRS_PLUGIN_URL . '/assets/js/mce-button.js';
    return $plugin_array;
}
...
function drstk_get_assoc_meta_options()
{
    ...
    if ($meta_options == null) {
        $meta_options = ['full_title_ssi', 'creator_tesim', 'abstract_tesim'];
    }
    return $meta_options;
}
...
function drstk_get_errors()
{
    $errors = [
        'admin' => [
            'api_fail' =>
                'Sorry, DRS files and metadata are currently unavailable. Please refresh the page or try again later. If problem persists please contact dsg@neu.edu.',
        ],
        'search' => [
            'no_results' =>
                'Your query produced no results. Please refine your search and try again.',
            'fail_null' =>
                'Sorry, these project materials are currently unavailable. Please try again later.',
            'no_sub_collections' => 'This project has no sub-collections.',
            'missing_collection' =>
                'No collections are available at this time. Please contact the site administrator.',
        ],
        'item' => [
            'no_results' =>
            ...
            'jwplayer_fail' =>
                'There was an issue playing this file. Please contact the site administrator.',
        ],
        'shortcodes' => [
            'fail' =>
                'Sorry, project materials are currently unavailable. Please refresh the page or try again later. If problem persists please contact the site administrator.',
...
{
    $collection_pid =
        get_option('drstk_collection') != ''
            ? get_option('drstk_collection')
            : 'https://repository.library.northeastern.edu/collections/neu:1';
    echo '<input name="drstk_collection" type="text" value="' .
        $collection_pid .
        '" style="width:100%;"></input><br/>
...
function drstk_home_url_callback()
{
    ...
    echo '<input name="drstk_home_url" type="text" value="' .
        $url_base .
        '"></input><br/>
     <small>This sets the URL permalink base for /browse/, /search/, /item/, and /collection/<br/>
     Currently, yours will look like: <strong>' .
        drstk_home_url() .
        'browse/</strong></small>';
}
...
function drstk_podcast_page_callback()
{
    ...
    echo "<p><a href='" .
        get_page_link($selected, false) .
        "'>" .
        get_the_title($selected) .
        '</a></p>';
}
...
{
    $leaflet_api_key =
        get_option('leaflet_api_key') != ''
            ? get_option('leaflet_api_key')
            : '';
    echo '<input name="leaflet_api_key" type="text" value="' .
        $leaflet_api_key .
        '" style="width:100%;"></input><br/>
...
{
    $leaflet_project_key =
        get_option('leaflet_project_key') != ''
            ? get_option('leaflet_project_key')
            : '';
    echo '<input name="leaflet_project_key" type="text" value="' .
        $leaflet_project_key .
        '" style="width:100%;"></input><br/>
...
function drstk_search_metadata_callback()
{
    ...
    foreach ($search_meta_options as $option) {
        echo '<label><input type="checkbox" name="drstk_search_metadata[]" value="' .
            $option .
            '"';
...
function drstk_browse_metadata_callback()
{
    ...
    foreach ($browse_meta_options as $option) {
        echo '<label><input type="checkbox" name="drstk_browse_metadata[]" value="' .
            $option .
            '"';
        if (is_array($options) && in_array($option, $options)) {
            echo 'checked="checked"';
...
{
    $sort_options = [
        'title_ssi%20asc' => 'Title A-Z',
        'title_ssi%20desc' => 'Title Z-A',
        'score+desc%2C+system_create_dtsi+desc' => 'Relevance',
        'creator_ssi%20asc' => 'Creator A-Z',
        'creator_ssi%20desc' => 'Creator Z-A',
        'system_modified_dtsi%20asc' => 'Date (earliest to latest)',
        'system_modified_dtsi%20desc' => 'Date (latest to earliest)',
    ];
...
{
    $per_page_options = ['10' => '10', '20' => '20', '50' => '50'];
...
function drstk_facets_callback()
{
    ...
    foreach ($facets_to_display as $option) {
        echo '<tr><td style="padding:0;"><input type="checkbox" name="drstk_facets[]" value="' .
            $option .
            '" checked="checked"/> <label> <span class="dashicons dashicons-sort"></span> ' .
            titleize($option) .
            '</label></td>';
        echo '<td style="padding:0;" class="title"><input type="text" name="drstk_' .
            $option .
            '_title" value="' .
            get_option('drstk_' . $option . '_title') .
            '"></td></tr>';
    }
    foreach ($facet_options as $option) {
        if (!in_array($option, $facets_to_display)) {
            echo '<tr><td style="padding:0;"><input type="checkbox" name="drstk_facets[]" value="' .
                ...
                titleize($option) .
                '</label></td>';
            echo '<td style="padding:0;display:none" class="title"><input type="text" name="drstk_' .
                $option .
                '_title" value="' .
                get_option('drstk_' . $option . '_title') .
                '"></td></tr>';
...
{
    $sort_options = [
        'fc_desc' => 'Facet Count (Highest to Lowest)',
        'fc_asc' => 'Facet Count (Lowest to Highest)',
        'abc_asc' => 'Facet Title (A-Z)',
        'abc_desc' => 'Facet Title (Z-A)',
    ];
...
function drstk_niec_metadata_callback()
{
    ...
    if (is_array($niec_facets_to_display)) {
        foreach ($niec_facets_to_display as $option) {
            echo '<tr><td style="padding:0;"><input type="checkbox" name="drstk_niec_metadata[]" value="' .
                $option .
                '" checked="checked"/> <label> <span class="dashicons dashicons-sort"></span> ' .
                titleize($option) .
                '</label></td>';
            echo '<td style="padding:0;" class="title"><input type="text" name="drstk_niec_' .
                $option .
                '_title" value="' .
                get_option('drstk_niec_' . $option . '_title') .
                '"></td></tr>';
        }
    }
    foreach ($niec_facet_options as $option) {
        if (
            ...
            (is_array($niec_facets_to_display) &&
                !in_array($option, $niec_facets_to_display))
        ) {
            echo '<tr><td style="padding:0;"><input type="checkbox" name="drstk_niec_metadata[]" value="' .
                $option .
                '"/> <label> <span class="dashicons dashicons-sort"></span> ' .
                titleize($option) .
                '</label></td>';
            echo '<td style="padding:0;display:none" class="title"><input type="text" name="drstk_niec_' .
                $option .
                '_title" value="' .
                get_option('drstk_niec_' . $option . '_title') .
                '"></td></tr>';
...
function drstk_mirador_url_callback()
{
    $mirador_url =
        get_option('drstk_mirador_url') == ''
            ? 'mirador'
            : get_option('drstk_mirador_url');
    echo '<input name="drstk_mirador_url" type="text" value="' .
        $mirador_url .
        '"></input><br/>
     <small>This sets the URL path for the mirador viewer<br/>
     Currently, yours will look like: <strong>' .
        drstk_home_url() .
        'mirador/</strong></small>';
}
...
function drstk_item_page_metadata_callback()
{
    ...
    $item_options =
        get_option('drstk_item_page_metadata') != ''
            ? get_option('drstk_item_page_metadata')
            : [];
    echo '<table class="drstk_item_metadata"><tbody id="item_metadata_sortable">';
    foreach ($item_options as $option) {
        echo '<tr><td style="padding:0"><label><input type="checkbox" name="drstk_item_page_metadata[]" value="' .
            $option .
            '" ';
...
function drstk_assoc_file_metadata_callback()
{
    ...
    foreach ($all_assoc_meta_options as $option) {
        echo '<label><input type="checkbox" name="drstk_assoc_file_metadata[]" value="' .
            $option .
            '" ';
...
function drstk_annotations_callback()
{
    ...
    if (get_option('drstk_annotations') == 'on') {
        echo 'checked="checked"';
    }
    echo '/>Display</label>';
}
...
function drstk_podcast_image_url_callback()
{
    $url = get_option('drstk_podcast_image_url')
        ? get_option('drstk_podcast_image_url')
        : 'https://brand.northeastern.edu/wp-content/uploads/logotype-250x85.png';
...
function drstk_content_template($template)
{
    ...
    if (isset($wp_query->query_vars['drstk_template_type'])) {
        ...
        if (
            $template_type == 'browse' ||
            $template_type == 'search' ||
            $template_type == 'collections' ||
            ...
            $theme_template = locate_template([
                $TEMPLATE_THEME['browse_template'],
            ]);
            ...
            // look for theme template first, load plugin template as fallback
            $theme_template = locate_template([
                $TEMPLATE_THEME['download_template'],
            ]);
            return $theme_template
                ? $theme_template
            ...
            // look for theme template first, load plugin template as fallback
            $theme_template = locate_template([
                $TEMPLATE_THEME['mirador_template'],
            ]);
            return $theme_template
                ? $theme_template
                : $TEMPLATE['mirador_template'];
        }
    } else {
        return $template;
    }
...
function drstk_browse_script()
{
    ...
    $niec_facets_to_display = [];
    if (is_array($niec_facets)) {
        foreach ($niec_facets as $facet) {
            $niec_facets_to_display[$facet] = drstk_get_facet_name(
                $facet,
                true
            );
        }
    ...
    if (
        get_option('drstk_niec') == 'on' &&
        count($niec_facets_to_display) > 0
    ) {
...
function drstk_item_script()
{
    ...
    wp_register_script(
        'drstk_cdn_jwplayer',
        'https://content.jwplatform.com/libraries/dTFl0VEe.js'
    );
    wp_enqueue_script('drstk_cdn_jwplayer');
    wp_register_script(
        'drstk_elevatezoom',
        plugins_url(
            '/assets/js/elevatezoom/jquery.elevateZoom-3.0.8.min.js',
            __FILE__
        ),
        []
    );
...
function drstk_breadcrumb_script()
{
    ...
    wp_localize_script('drstk_breadcrumb', 'breadcrumb_obj', [
        'ajax_url' => admin_url('admin-ajax.php'),
...
function drstk_mirador_script()
{
    ...
    wp_register_script(
        'drstk_mirador',
        plugins_url('/assets/mirador/mirador.js', __FILE__)
    );
    wp_enqueue_script('drstk_mirador');
    wp_register_script(
        'drstk_mirador_manifest',
        plugins_url('/assets/mirador/mirador_manifest.js', __FILE__),
        []
    );
    wp_enqueue_script('drstk_mirador_manifest');
    wp_register_style(
        'drstk_mirador_style',
        plugins_url('/assets/mirador/css/mirador-combined.min.css', __FILE__),
        []
    );
...
function get_response($url)
{
    ...
    switch ($response_status) {
        ...
        case 302:
            ...
            $status_message =
                'The resource has moved or is no longer available';
            break;
        default:
            $output = 'An unknown error occured.' . $response_status;
...
{
    $drstk_url = get_option('drstk_home_url')
        ? get_option('drstk_home_url')
        : '/';
...
function remove_bstw_widget_text_filters()
{
    if (function_exists('bstw')) {
        remove_filter(
            'widget_text',
            [bstw()->text_filters(), 'do_shortcode'],
            10
        );
    }
}
...
add_filter(
    ...
    'drstk_image_attachment_fields_to_edit',
    null,
    2
);
...
add_filter(
    ...
    'drstk_image_attachment_fields_to_save',
    10,
    2
);
...
add_filter(
    ...
    'debug_change_feed_cache_transient_lifetime',
    200000
);
