 ...
 $("body").on('click', "#insert-drs",  function(){
  ...
  //jQuery for Custom item Popup
     ...
     $("body").on("click", "[id^=submit_custom_item]", function(){
         $("#add_custom_item").css("display", "none");
         var custom_item_url = $("#custom_item__url").val();
