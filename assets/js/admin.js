  ...
  //enables the search button
   ...
   $("body").on("click", "[id^=drstk_insert_]", function(e){
     ...
     if(type == 'tile'){
       ...
       if ($.isNumeric(cell_width) && cell_width != 200){
       ...
       if ($.isNumeric(cell_height) && cell_height != 200){
     ...
     if(type == 'item'){
       ...
       shortcode += ' align="'+$("#drsitem-align").val()+'"';
       shortcode += ' caption-align="'+$("#drsitem-caption-align").val()+'"';
       if (metadata.length > 0) {shortcode += ' metadata="'+metadata+'"';}
       shortcode +=']\n';
     }
     if(type == 'video'){
