...
jQuery(document).ready(function ($) {
    ...
    $(".site-content .row").prepend('<div id="search-and-facet"><form id="check1" class="search"><input id="test1" type="text" placeholder="Search timeline ..."><button id="searchTimelineItems" class="fa fa-search" style="padding-right: 45px;"></button></form><br><br></div>');
    $("#search-and-facet").append("<div id='drs-facets'></div>");
