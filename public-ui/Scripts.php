...
class Scripts {
    ...
    static function itemScript() {
        ...
        // @todo update this to WP's current function
        wp_localize_script('drstk_item_gallery', 'item_obj', $item_obj);

    }

    static function breadcrumbScript(): void {
        global $wp_query;
        global $VERSION;
    ...
    static function browseScript(): void {
        ...
        // @todo use the updated WP function
