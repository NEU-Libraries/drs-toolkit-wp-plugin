...
class TestMapFunctions(unittest.TestCase):
    ...
    def testSelectAll(self):
        ...
        try:
            wp_add_page()
            driver.find_element_by_xpath("//*[@id='backbone_modal_dialog']/div[1]/div/section/article/table/tbody/tr[2]/td[2]/a").click()
            time.sleep(drs_page_load_wait)
            items_on_screen = driver.find_elements_by_id("sortable-map-list")[0].find_elements_by_tag_name("input")
            ...
            self.assertEqual(pre_count,post_count,"All the items have been selected")
        except Exception as e:
        ...
        try:
            ...
            if checkbox.is_selected():
                ...
                for item in items_on_screen:
                    if not item.is_selected():
                        post_count = post_count + 1
            self.assertEqual(pre_count, post_count, "All the items have been Unselected")
        except Exception as e:
            ...
            if not checkbox.is_selected():
                ...
                for item in items_on_screen:
                    if not item.is_enabled():
                        post_count = post_count + 1
            self.assertEquals(pre_count, post_count, "All the items checkboxes have been disabled")
        except Exception as e:
        ...
        try:
            ...
            if checkbox.is_selected():
                ...
                for item in items_on_screen:
                    if item.is_enabled():
                        post_count = post_count + 1
            self.assertEqual(pre_count, post_count, "All the items have been enabled")
        except Exception as e:
