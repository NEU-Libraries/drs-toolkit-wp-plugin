...
class TestTimelineFunctions(unittest.TestCase):
    ...
    def test4(self):
        ...
        time.sleep(drs_page_load_wait)
        elem2 = driver.find_element_by_css_selector("#sortable-timeline-list .drstk-include-timeline[1]")
        elem2.click()
    ...
    def test13(self):
        ...
        time.sleep(drs_page_load_wait)
        driver.find_element_by_css_selector("#sortable-timeline-list .drstk-include-timeline[0]").click()
        pid = driver.find_element_by_css_selector("#sortable-timeline-list .drstk-include-timeline[0]").get_attribute("value")
