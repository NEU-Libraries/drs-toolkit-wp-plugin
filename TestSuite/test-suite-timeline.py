...
class TestTimelineFunctions(unittest.TestCase):
    ...
    def test4(self):
        ...
        time.sleep(drs_page_load_wait)
        time.sleep(drs_page_load_wait)
        elem1 = driver.find_elements_by_css_selector("#sortable-timeline-list .drstk-include-timeline")[0]
        driver.execute_script("return arguments[0].scrollIntoView();", elem1)
        elem1.click()
        time.sleep(drs_page_load_wait)
        elem2 = driver.find_elements_by_css_selector("#sortable-timeline-list .drstk-include-timeline")[1]
        driver.execute_script("return arguments[0].scrollIntoView();", elem2)
        elem2.click()
    ...
    def test14(self):
        ...
        time.sleep(drs_page_load_wait)
        element = driver.find_element_by_xpath("//*[@id='timeline_greenlegend']")
