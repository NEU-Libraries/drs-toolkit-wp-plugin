...
1. Log in to new Wordpress site as admin user

1. Install Quest theme (go to /wp-admin/theme-install.php and search for quest then click install)

1. SSH into correct directory on server and git clone this repo into wp-content/plugins
