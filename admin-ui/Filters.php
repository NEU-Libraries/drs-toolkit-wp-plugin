...
class Filters {
    ...
    static function imageAttachmentFieldsToSave(int $post, array $attachment) {
    ...
    static function imageAttachmentFieldsToEdit(array $formFields, $post): array {
        $formFields["timeline_date"] = array(
            "label" => __("Timeline Date"),
            "input" => "text", // this is default if "input" is omitted
            "value" => get_post_meta($post->ID, "_timeline_date", true),
            "helps" => "Must be YYYY/MM/DD format"
        );
        $formFields["map_coords"] = array(
    ...
    static function podcastPageTemplate($template) {
    ...
    static function contentTemplate($template) {
        global $wp_query;
        global $TEMPLATE;
    ...
    static function addQueryVar($publicQueryVars) {
        $publicQueryVars[] = 'drstk_template_type';
        $publicQueryVars[] = 'pid';
        $publicQueryVars[] = 'js';
