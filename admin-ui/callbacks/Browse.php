...
class Browse {
    ...
    static function browsePageTitle() {
    ...
    static function browseMetadata() {
    ...
    static function defaultBrowsePerPage() {
    ...
    static function browseShowFacets() {
    ...
    static function defaultSortCallback() {
