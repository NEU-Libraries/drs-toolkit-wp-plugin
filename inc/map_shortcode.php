...
function drstk_map_shortcode_scripts() {
    ...
    if (
        ...
        wp_register_script(
            'drstk_cdn_leaflet_marker_cluster_js',
        ...
        wp_register_style(
            'drstk_cdn_leaflet_marker_cluster_css',
            'https://unpkg.com/leaflet.markercluster@1.4.1/dist/MarkerCluster.css'
        );
        wp_enqueue_style('drstk_cdn_leaflet_marker_cluster_css');

        wp_register_style(
            'drstk_cdn_leaflet_marker_cluster_default_css',
        ...
        wp_register_script(
            'drstk_cdn_leaflet_easy_button_js',
        ...
        wp_register_style(
            'drstk_cdn_leaflet_easy_button_css',
